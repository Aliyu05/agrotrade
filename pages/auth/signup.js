            ...
            <div className="w-full md:w-[420px] flex flex-col gap-3 border border-gray-300 rounded-md p-3">
                ...
                <div className="flex flex-col gap-5 md:gap-3">
                    <ul className="grid grid-cols-2">
                        <li className={`text-center font-bold pb-3 cursor-pointer ${tab == 'farmer'? styles.tabcolor : null}`}
                        onClick={() => setTab('farmer')}>Farmer</li>

                        <li className={`text-center font-bold pb-3 cursor-pointer ${tab == 'buyer'? styles.tabcolor : null}`}
                        onClick={() => setTab('buyer')}>Buyer</li>
                    </ul>

                <div className="flex flex-col gap-2">
                    <h2 className="text-2xl">{`Register a ${tab} buyer account`}</h2>
                ...
                <form>
                    ...
                    {/* OR seperator */}
                    <div className="separator"> <span className='text-gray-500 my-3'>OR</span> </div>
